 ...
 * @author Allan
 */
public class JIFUnidade extends javax.swing.JInternalFrame {

    /**
     * Creates new form JIFInstituicao
     */
    public JPUnidade jpunidade;

    public JIFUnidade() {
        initComponents();
        jpunidade = new JPUnidade();//add na frame
        jTabbedPane1.addTab("Unidade Medida", jpunidade);// adcionando no painel
    }
